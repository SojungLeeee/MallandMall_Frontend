...
const SearchBar = () => {
  ...
  return (
    <form className="flex items-center w-full caret-transparent">
      <div className="flex-grow relative ml-0.5 mb-2 flex justify-center">
        <div className="w-11/12 relative">
          <input
            type="text"
            placeholder="Mall&Mall에 오신것을 환영합니다!"
            readOnly
            className="w-full p-3 pl-2 pr-10 text-gray-800 placeholder-gray-400 border border-gray-300 rounded-sm focus:outline-none"
