  ...
  return (
    <div className="container mx-auto p-6 bg-gray-50 min-h-screen">
      <div className="bg-white shadow-lg rounded-lg p-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">📌 질문 상세</h1>
        <div className="border-b pb-4">
          <h2 className="text-xl font-semibold text-gray-700">
            {question.title}
          </h2>
          <p className="text-sm text-gray-500">작성자: {question.userId}</p>
          ...
          <div className="mt-6">
            ...
            <table className="min-w-full mt-3 bg-white border border-gray-200 rounded-lg shadow-sm">
              <thead className="bg-gray-100">
                <tr>
                  <th className="py-2 px-4 border-b text-left">답변 내용</th>
                  <th className="py-2 px-4 border-b text-center">수정</th>
                  <th className="py-2 px-4 border-b text-center">삭제</th>
                </tr>
              </thead>
              <tbody>
